...
function build() {
  return src(['app/css/style.min.css', 'app/js/main.min.js', 'app/fonts/*'], {
      base: 'app',
    })
    .pipe(dest('dist'));
}
...
function buildhtml() {
  return src(['app/**/*.html', '!app/parts/**/*']).pipe(dest('dist'));
}

function watching() {
  watch(['app/parts/**/*.html'], includes);
